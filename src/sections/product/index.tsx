...
export default function Product() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col lg:flex-row-reverse lg:justify-between items-center lg:gap-10">
        <div className="w-full lg:w-1/2 py-4 lg:py-0 flex flex-col justify-center items-center lg:items-start">
          <h3 className="text-black text-[40px] md:text-[55px] leading-tight font-[700] text-center lg:text-left">
            <span className="text-red-600">Qué es</span> <br /> Vitaly{" "}
            <span className="text-red-600">Plus?</span>
          </h3>
          <p className="text-black text-[20px] md:text-[22px] text-center lg:text-left">
            The leading health and beauty product
          </p>

          <p className="text-black text-center lg:text-start font-[300] py-6 text-[18px]">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
          <p className="text-black text-center lg:text-start font-[300] py-5 text-[18px]">
