...
export default function Benefits() {
  return (
    <div className="relative bg-[#1E1E1E] w-full h-auto flex flex-col lg:flex-row gap-12 py-12 px-4 md:px-8 lg:px-10 xl:px-16">
      ...
      <div className="w-full flex flex-col lg:flex-row justify-start 2xl:items-center items-start gap-10 z-20 relative">
        <div className="lg:flex lg:flex-col lg:gap-12 xl:gap-24">
          <div className="w-full flex flex-col justify-start items-start">
            ...
            <p className="text-[17px] xl:text-[21px]">
